...
app_setup_complete = "edupro_sms.hooks._import_api_modules"
...
permission_query_conditions = {
	"Report Card": "edupro_sms.doctype.report_card.report_card.get_permission_query_conditions",
...
has_permission = {
	"Report Card": "edupro_sms.doctype.report_card.report_card.has_permission",
